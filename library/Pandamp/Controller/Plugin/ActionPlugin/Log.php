...
class Pandamp_Controller_Plugin_ActionPlugin_Log extends Pandamp_Controller_Plugin_ActionPlugin_Action {
    ...
    private function getNotificationString($impact, IDS_Report $result, $level) {
    	$retstr = "[HUKUMONLINE] detected a potential attack! @LEVEL: " . $level;
