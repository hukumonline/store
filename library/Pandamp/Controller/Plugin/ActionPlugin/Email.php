...
class Pandamp_Controller_Plugin_ActionPlugin_Email extends Pandamp_Controller_Plugin_ActionPlugin_Action {
    ...
    private function sendMail($notification, $options) {
    	...
    	if (null == $this->_email) {
			...
			$mail->setFrom($options['from'], 'Hukumonline Notification');
		...
		$mail->setSubject( (isset($options['subject']) ? $options['subject'] : 'Hukumonline Notification: potential attack on your website') );
